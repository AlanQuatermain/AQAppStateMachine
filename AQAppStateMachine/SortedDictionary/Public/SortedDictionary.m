...
/**
 ...
 \see initWithObjectsAndKeys:
 */
- (id) initWithObjects: (const id []) objects forKeys: (const id []) keys count: (NSUInteger) objectCount {
	if (self = [self init]) {
...
- (NSArray *) allKeysForObject: (id) anObject {
	NSMutableArray *keys = [NSMutableArray array];//[[[NSMutableArray alloc] init] autorelease];
